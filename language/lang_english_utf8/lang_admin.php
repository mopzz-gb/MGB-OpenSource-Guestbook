<?php
	...
	*/
	...
	$lang['empty_needed_value'][20] = "Missing Captcha X-coordinates";
	$lang['empty_needed_value'][21] = "Missing Captcha Y-coordinates";
	...
	$lang['spam_entry_type'][14] = "Blocked by stopforumspam";

	// SYSTEM LOG TYPES
	$lang['sys_log_type'][1001] = "<b>{ENTRY_USER}</b> has logged into the administration.";
	$lang['sys_log_type'][1002] = "<b>{ENTRY_USER}</b> has logged out correctly from the administration.";
	$lang['sys_log_type'][1003] = "<b>{ENTRY_USER}</b> has edited “General”.";
	$lang['sys_log_type'][1004] = "<b>{ENTRY_USER}</b> has edited “Appearance”.";
	$lang['sys_log_type'][1005] = "<b>{ENTRY_USER}</b> has edited “Form fields”.";
	$lang['sys_log_type'][1006] = "<b>{ENTRY_USER}</b> has edited “Security & Anti-Spam”.";
	$lang['sys_log_type'][1007] = "<b>{ENTRY_USER}</b> has edited “BBCodes”.";
	$lang['sys_log_type'][1008] = "<b>{ENTRY_USER}</b> has edited “Emoticons”.";
	$lang['sys_log_type'][1009] = "<b>{ENTRY_USER}</b> has edited “Gravatar”.";
	$lang['sys_log_type'][1010] = "<b>{ENTRY_USER}</b> has edited “E-mails”.";
	$lang['sys_log_type'][1011] = "<b>{ENTRY_USER}</b> has created a database backup.";
	$lang['sys_log_type'][1012] = "<b>{ENTRY_USER}</b> has deleted a database backup.";
	$lang['sys_log_type'][1013] = "<b>{ENTRY_USER}</b> has activated one or more entries.";
	$lang['sys_log_type'][1014] = "<b>{ENTRY_USER}</b> has de-activated one or more entries.";
	$lang['sys_log_type'][1015] = "<b>{ENTRY_USER}</b> has deleted one or more entries.";
	$lang['sys_log_type'][1016] = "<b>{ENTRY_USER}</b> has edited one or more entries.";
	$lang['sys_log_type'][1017] = "<b>{ENTRY_USER}</b> edited the smilies.";
	$lang['sys_log_type'][1018] = "<b>{ENTRY_USER}</b> has added a new user ({ENTRY_USER_NEW}).";
	$lang['sys_log_type'][1019] = "<b>{ENTRY_USER}</b> edited a user ({ENTRY_USER_EDIT}).";
	$lang['sys_log_type'][1020] = "<b>{ENTRY_USER}</b> deleted a user ({ENTRY_USER_EDIT}).";
	$lang['sys_log_type'][1021] = "<b>{ENTRY_USER}</b> edited the IP-List.";
	$lang['sys_log_type'][1022] = "<b>{ENTRY_USER}</b> edited the e-mail list.";
	$lang['sys_log_type'][1023] = "<b>{ENTRY_USER}</b> edited the domain list.";
	$lang['sys_log_type'][1024] = "<b>{ENTRY_USER}</b> managed the spam log.";
	$lang['sys_log_type'][1025] = "An incorrect password was submitted for user <b>{ENTRY_USER}</b>.";
	$lang['sys_log_type'][1026] = "An information e-mail has been sent to <b>{ENTRY_NAME} ({ENTRY_EMAIL})</b>.";
	$lang['sys_log_type'][1027] = "A new password for <b>{ENTRY_USER}</b> has been requested.";
	$lang['sys_log_type'][1028] = "Successfully sent a new password to <b>{ENTRY_USER}</b>.";
	$lang['sys_log_type'][1029] = "A new password for an invalid email address was requested by <b>{ENTRY_IP}</b>.";
	$lang['sys_log_type'][1030] = "<b>{ENTRY_USER}</b> has restored a database backup.";
	$lang['sys_log_type'][1031] = "<b>{ENTRY_USER}</b> has modified the consent to the usage statistics.";
	$lang['sys_log_type'][2001] = "index.php: the cache has been reset or deleted..";
	$lang['sys_log_type'][2002] = "index.php: The IP address <b>{ENTRY_IP}</b> was automatically removed from the block list.";
	$lang['sys_log_type'][3001] = "<b>newentry.php</b>: The IP address <b>{ENTRY_IP}</b> has been automatically added to the block list.";
	$lang['sys_log_type'][3002] = "<b>newentry.php</b>:The IP address <b>{ENTRY_IP}</b> was automatically removed from the block list.";
	$lang['sys_log_type'][3003] = "<b>newentry.php</b>: A direct access without a referrer from IP <b>{ENTRY_IP}</b> has been blocked.";
	$lang['sys_log_type'][3004] = "<b>newentry.php</b>: The IP <b>{ENTRY_IP}</b> was rejected for typing too fast.";
	$lang['sys_log_type'][3005] = "<b>newentry.php</b>: The captcha was submitted incorrectly from IP <b>{ENTRY_IP}</b>.";
	$lang['sys_log_type'][3006] = "<b>newentry.php</b>: An information e-mail was sent to <b>{ENTRY_NAME} ({ENTRY_EMAIL})</b> following a valid guestbook entry.";
	$lang['sys_log_type'][3007] = "<b>newentry.php</b>: <b>stopforumspam</b> accepted an entry but marked it as spam => {ENTRY_NAME}, {ENTRY_EMAIL}";
	$lang['sys_log_type'][3008] = "<b>newentry.php</b>: <b>stopforumspam</b> has rejected an entry => {ENTRY_NAME}, {ENTRY_EMAIL}";
	$lang['sys_log_type'][4001] = "<b>email.php</b> An email has been sent.<br><br>Name: <b>{ENTRY_NAME}</b><br>Email: <b>{ENTRY_EMAIL}</b><br>Text: <b>{ENTRY_TEXT}</b><br>IP: <b>{ENTRY_IP}</b>";
	$lang['sys_log_type'][4002] = "<b>email.php</b>: The IP address <b>{ENTRY_IP}</b> was automatically added to the block list.";
	$lang['sys_log_type'][4003] = "<b>email.php</b>: The IP address <b>{ENTRY_IP}</b> has been automatically removed from the block list.";
	$lang['sys_log_type'][4004] = "<b>email.php</b>: The captcha was submitted incorrectly from IP <b>{ENTRY_IP}</b>.";
	$lang['sys_log_type'][4005] = "<b>email.php</b>: A direct access without a referrer from IP <b>{ENTRY_IP}</b> has been blocked.";
	$lang['sys_log_type'][4006] = "<b>email.php</b>: An entry was denied by stopforumspam => {ENTRY_NAME, {ENTRY_EMAIL}";
	$lang['sys_log_type'][5001] = "<b>upgrade.php</b>: Successfull database upgrade.";
	...
	$lang['spam_all_ips_on_ip_list'] = "All IPs are already on the IP block list.";
	$lang['spam_all_emails_on_email_list'] = "All e-mails are already on the e-mail block list.";
	$lang['spam_all_domains_on_domain_list'] = "All domains are already on the domain block list.";
	...
	// SPAM_LOG.INC.PHP
	$lang['entries_uploaded'] = "{COUNTER} entries were transmitted<br>to www.stopforumspam.com in {TIME} seconds.";
	$lang['entries_sneaked'] = "{COUNTER} entries were transmitted<br>to www.stopforumspam.com in {TIME} seconds.";
	$lang['entries_already_sneaked'] = "All entries have already been sent to www.stopforumspam.com.";
	$lang['shortened'] = "&nbsp;[...]";
	$lang['last_contact'] = "Last contact before:";
	$lang['in_list_since'] = "On the list since:";
	...
	$lang['show_banned_by_ip_only'] = "➔ Display banned by ip only";
	$lang['show_banned_by_email_only'] = "➔ Display banned by email only";
	$lang['show_banned_by_domain_only'] = "➔ Display banned by domain only";
	$lang['show_banned_by_keystroke_only'] = "➔ Display banned by keystroke only";
	$lang['show_banned_by_captcha_only'] = "➔ Display blocked by captcha only";
	$lang['show_everything'] = "➔ Display all entries";
	$lang['show_admin_actions'] = "➔ Display administration activities";
	$lang['show_block_actions'] = "➔ Display guestbook block actions";
	$lang['show_login_fails'] = "➔ Display failed logins";
	$lang['show_sent_emails'] = "➔ Display sent emails";
	...
	$lang['confirm_report_spam'] = "Sneak it!";
	...
	$lang['settings_telemetry'] = "Usage statistics";
	...
	$lang['mastodon_nav'] = "MGB on Mastodon";
	$lang['github_nav'] = "MGB on GitHub";
	...
	$lang['edit_caption_autoblock'] = "Automatic IP blocking";
	...
	$lang['edit_caption_telemetry'] = "Anonymous usage statistics";
	...
	$lang['edit_autoblock'] = "Automatic blocking of IPs:";
	$lang['edit_autoblock_config'] = "Configuration:";
	$lang['edit_banlist_cleanup'] = "Automatic blocklist cleanup:";
	$lang['edit_telemetry'] = "Anonymous usage statistics:";
	$lang['edit_telemetry_ping'] = "Address for the ping:";
	$lang['edit_telemetry_install_id'] = "Unique MGB ID:";

	$lang['edit_expl_title'] = "The title of the guestbook.";
	$lang['edit_expl_h_author'] = "The name of the author of the internet page.";
	...
	$lang['edit_expl_autoblock'] = "Should IPs that trigger a warning within the time specified in the configuration be added to the block list automatically?";
	$lang['edit_expl_autoblock_config'] = "Sets the delay during which a warning must be triggered in order to be automatically added to the guestbooks block list.";
	$lang['edit_expl_banlist_cleanup'] = "If this option is activated, entries in the block lists will be automatically deleted after the specified blocking period.";
	$lang['edit_expl_telemetry'] = "If this option is enabled, the guestbook sends anonymous technical information once a day (Version, PHP-Version, random installation ID).<br><br><b>No</b> personal data, such as IP address, installation location, etc., is transmitted.";
	$lang['edit_expl_telemetry_ping'] = "Please do <b>not</b> change this address. Only do so if a post on the official forum <b>explicitly</b> asks you to do so!";
	$lang['edit_expl_telemetry_install_id'] = "Your unique guestbook ID created during installation. Cannot be changed.";
	...
	$lang['r_banlists'] = "Manage blocklists:";
	$lang['r_edit_smilies'] = "Edit emoticons";
	$lang['r_telemetry'] = "Manage usage statistics:";
	...
	$lang['sql_dump_successfull'] = "SQL dump successfully created in {TIME} seconds.";
	$lang['time_needed'] = "This took {TIME} seconds.";
	...
	$lang['old_version'] = "Your version is outdated.<br>An update is recommended.<br><br><a href=\'https://www.m-gb.org/index.php?id=download_gb\' class=\'admin\' target=\'_blank\' title=\'Update now\'>Show the latest version</a>";
	...
	$lang['new_version_available'] = "A new version is available: <a href=\'https://www.m-gb.org/files/latest/mgb-latest.zip\' class=\'admin\' target=\'_blank\' title=\'Upgrade now!\'>{LATEST_VERSION}</a>";
