<?php
	...
	*/
	...
	$lang['empty_needed_value'][44] = "Clé publique ou clé de notation (Scoring Key) pour Ayah (Are you a human?) manquante,<br> ou le plug-in Ayah n'est pas installé.";
	...
	$lang['captcha_method_ayah'] = "Es-tu un humain ?";
	...
	$lang['confirm_report_to_stopforumspam'] = "Veux-tu vraiment envoyer cette entrée à www.stopforumspam.com ?";
	...
	$lang['edit_caption_ayah'] = "Ayah (Es-tu un humain)";
	...
	$lang['edit_wrong_captcha_count'] = "Nombre maximal de saisies erronées du Captcha:";
 	...
 	$lang['edit_akismet_plugin'] = "Plugin Akismet:";
	...
	$lang['edit_expl_direct_access_text'] = "Ici, tu peux saisir une ou plusieurs adresses URL spécifiques (séparées par des virgules) qui doivent figurer dans le référent (Referer) d'un formulaire d'inscription afin que l'accès soit autorisé. <br><br><b>– Laisser vide pour interdire l'accès uniquement lorsque le référent est vide, c'est-à-dire en cas d'appel direct. <br>– Tu peux saisir plusieurs domaines séparés par des virgules.</b>";
	$lang['edit_expl_search_engines_excluded'] = "Détermine si les moteurs de recherche sont exclus ou non de la réglementation.";
	$lang['edit_expl_search_engines'] = "Saisis ici les identifiants des moteurs de recherche transmis dans le HTTP_REFERER, séparés par des virgules. Les différents référents sont ensuite vérifiés par rapport à ces identifiants. <br><br><b>Par défaut lors de l'installation: Googlebot/, Baiduspider, bingbot/, MJ12bot/, Exabot, ia_archiver, msnbot/, Yahoo! Slurp, SEO search Crawler/, crawleradmin.t-info@telekom.de</b>";
	...
	$lang['edit_expl_for_ban_required'] = "Coche les cases nécessaires pour refuser l'inscription.";
	...
	$lang['edit_expl_stopforumspam_api_key'] = "Pour signaler toi-même des entrées spam au site, tu doit saisir ici une clé API. Pour obtenir une clé API, il faut s'inscrire sur le <a href=“http://www.stopforumspam.com/forum/” target=“_blank”>Forum</a> du site, puis <a href=“http://www.stopforumspam.com/signup” target=“_blank”>enregistrer une clé API</a>. <br><br><b>ATTENTION:</b> Aucune clé API n'est nécessaire pour vérifier les visiteurs par rapport à la liste. Tu n'en as besoin que pour signaler toi-même des entrées.";
	$lang['edit_expl_ayah_pub_key'] = "Pour pouvoir utiliser « Are you a human? » (« Êtes-vous un être humain »), il faut saisir la clé publique. Vous peux en demander une avec la « Scoring Key » sur <a href=“http://www.areyouahuman.com/” target=“_blank”>areyouahuman.com</a>.";
	$lang['edit_expl_ayah_score_key'] = "Saisis ici la « Scoring Key » (« clé de notation ») de « Are you a human? » (« Êtes-vous un humain? »).";
	...
	$lang['edit_expl_telemetry_ping'] = "Merci de <b>ne pas</b> modifier cette adresse. Sauf si une contribution correspondante dans le forum officiel le demande <b>explicitement</b> !";
	$lang['edit_expl_telemetry_install_id'] = "Ton identifiant unique créé lors de l'installation du livre des visiteurs. Ne peut pas être modifié.";
