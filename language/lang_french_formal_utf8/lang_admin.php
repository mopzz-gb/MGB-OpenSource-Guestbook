<?php
	...
	*/
	...
	$lang['no'] = "No";
	$lang['yes'] = "Oui";
	$lang['min'] = "Minimal"; // OK, wenn mask.; wenn fem., dann Minimale
	$lang['max'] = "Maximal"; // dito
	$lang['asc'] = "Ascendant";
	...
	$lang['empty_needed_value'][43] = "Clé API du www.stopforumspam.com manquante!";
	$lang['empty_needed_value'][44] = "Clé publique ou clé de notation pour Ayah (Are you a human?) manquante,<br> ou le plug-in Ayah n'est pas installé.";
	$lang['empty_needed_value'][45] = "Données non valides pour le nombre de lignes du captcha.";
	...
	$lang['spam_entry_type'][12] = "HTTP_REFERER incorrect";
	$lang['spam_entry_type'][13] = "Pas de HTTP_REFERER, requête directe";

	// SYSTEM LOG TYPES
	$lang['sys_log_type'][1001] = "<b>{ENTRY_USER}</b> s'est inscrit dans l'administration.";	
	$lang['sys_log_type'][1002] = "<b>{ENTRY_USER}</b> s'est correctement déconnecté de l'administration.";	
	$lang['sys_log_type'][1003] = "<b>{ENTRY_USER}</b> a modifié « Généralités ».";
	$lang['sys_log_type'][1004] = "<b>{ENTRY_USER}</b> a modifié « Apparence ».";
	$lang['sys_log_type'][1005] = "<b>{ENTRY_USER}</b> a modifié « Champs de formulaire ».";
	$lang['sys_log_type'][1006] = "<b>{ENTRY_USER}</b> a modifié « Sécurité et anti-spam ».";
	$lang['sys_log_type'][1007] = "<b>{ENTRY_USER}</b> a modifié « BBCodes ».";
	$lang['sys_log_type'][1008] = "<b>{ENTRY_USER}</b> a modifié « Émoticônes ».";
	$lang['sys_log_type'][1009] = "<b>{ENTRY_USER}</b> a modifié « Gravatar ».";
	$lang['sys_log_type'][1010] = "<b>{ENTRY_USER}</b> a modifié « E-mails ».";
	$lang['sys_log_type'][1011] = "<b>{ENTRY_USER}</b> a sauvegardé la base de données.";
	$lang['sys_log_type'][1012] = "<b>{ENTRY_USER}</b> a supprimé une copie de sauvegarde de la base de données.";
	$lang['sys_log_type'][1013] = "<b>{ENTRY_USER}</b> a débloqué une ou plusieurs entrées.";
	$lang['sys_log_type'][1014] = "<b>{ENTRY_USER}</b> a désactivé une ou plusieurs entrées.";
	$lang['sys_log_type'][1015] = "<b>{ENTRY_USER}</b> a supprimé une ou plusieurs entrées.";
	$lang['sys_log_type'][1016] = "<b>{ENTRY_USER}</b> a édité une ou plusieurs entrées.";
	$lang['sys_log_type'][1017] = "<b>{ENTRY_USER}</b> a modifié les émoticônes.";
	$lang['sys_log_type'][1018] = "<b>{ENTRY_USER}</b> a créé un nouveau utilisateur ({ENTRY_USER_NEW}.";
	$lang['sys_log_type'][1019] = "<b>{ENTRY_USER}</b> a édité un utilisateur ({ENTRY_USER_EDIT}.";
	$lang['sys_log_type'][1020] = "<b>{ENTRY_USER}</b> a supprimé un utilisateur ({ENTRY_USER_EDIT}.";
	$lang['sys_log_type'][1021] = "<b>{ENTRY_USER}</b> a édité la liste IP.";
	$lang['sys_log_type'][1022] = "<b>{ENTRY_USER}</b> a édité la liste E-mail.";
	$lang['sys_log_type'][1023] = "<b>{ENTRY_USER}</b> a édité la liste des domaines.";
	$lang['sys_log_type'][1024] = "<b>{ENTRY_USER}</b> a géré le protocole anti-spam.";
	$lang['sys_log_type'][1025] = "Pour l'utilisateur <b>{ENTRY_USER}</b> un mot de passe incorrect a été saisi.";
	$lang['sys_log_type'][1026] = "Un e-mail d'information a été envoyé à <b>{ENTRY_NAME} ({ENTRY_EMAIL})</b>.";
	$lang['sys_log_type'][1027] = "Un nouveau mot de passe a été demandé pour <b>{ENTRY_USER}</b>.";
	$lang['sys_log_type'][1028] = "<b>{ENTRY_USER}</b> a reçu avec succès un nouveau mot de passe.";
	$lang['sys_log_type'][1029] = "Un nouveau mot de passe a été demandé pour une adresse e-mail invalide de <b>{ENTRY_IP}</b>.";
	$lang['sys_log_type'][1030] = "<b>{ENTRY_USER}</b> a restauré une sauvegarde de base de données.";
	$lang['sys_log_type'][1031] = "<b>{ENTRY_USER}</b> a modifié son consentement aux statistiques d'utilisation.";
	$lang['sys_log_type'][2001] = "index.php: Le cache a été réinitialisé ou supprimé.";
	$lang['sys_log_type'][2002] = "index.php: L'adresse IP <b>{ENTRY_IP}</b> a été automatiquement supprimée de la liste noire.";
	$lang['sys_log_type'][3001] = "<b>newentry.php</b>: L'adresse IP <b>{ENTRY_IP}</b> a été automatiquement ajoutée à la liste noire.";
	$lang['sys_log_type'][3002] = "<b>newentry.php</b>: L'adresse IP <b>{ENTRY_IP}</b> a été automatiquement supprimée de la liste noire.";
	$lang['sys_log_type'][3003] = "<b>newentry.php</b>: Un accès direct sans réfèreur depuis l'adresse IP <b>{ENTRY_IP}</b> a été bloqué.";
	$lang['sys_log_type'][3004] = "<b>newentry.php</b>: L'adresse IP <b>{ENTRY_IP}</b> a été bloquée pour cause de saisie trop rapide.";
	$lang['sys_log_type'][3005] = "<b>newentry.php</b>: Le Captcha a été saisi incorrectement par l'adresse IP <b>{ENTRY_IP}</b>.";
	$lang['sys_log_type'][3006] = "<b>newentry.php</b>: Un e-mail d'information a été envoyé à <b>{ENTRY_NAME} ({ENTRY_EMAIL})</b> à la suite d'une insertion valide dans le livre des visiteurs.";
	$lang['sys_log_type'][3007] = "<b>newentry.php</b>: <b>stopforumspam</b> a accepté une entrée, mais l'a marquée comme spam => {ENTRY_NAME}, {ENTRY_EMAIL}";
	$lang['sys_log_type'][3008] = "<b>newentry.php</b>: <b>stopforumspam</b> a refusé une entrée => {ENTRY_NAME}, {ENTRY_EMAIL}";
	$lang['sys_log_type'][4001] = "<b>email.php</b> Un e-mail a été envoyé.<br><br>Nom: <b>{ENTRY_NAME}</b><br>E-mail: <b>{ENTRY_EMAIL}</b><br>Texte: <b>{ENTRY_TEXT}</b><br>IP: <b>{ENTRY_IP}</b>";
	$lang['sys_log_type'][4002] = "<b>email.php</b>: L'IP <b>{ENTRY_IP}</b> a été automatiquement ajoutée à la liste noire.";
	$lang['sys_log_type'][4003] = "<b>email.php</b>: L'IP <b>{ENTRY_IP}</b> a été automatiquement supprimée de la liste noire.";
	$lang['sys_log_type'][4004] = "<b>email.php</b>: Le Captcha a été saisi incorrectement par l'adresse IP <b>{ENTRY_IP}</b>.";
	$lang['sys_log_type'][4005] = "<b>email.php</b>: Un accès direct sans réfèreur depuis l'adresse IP <b>{ENTRY_IP}</b> a été bloqué.";
	...
	$lang['spam_all_ips_on_ip_list'] = "Toutes les adresses IP se trouvent déjà sur la liste noire des adresses IP.";
	$lang['spam_all_emails_on_email_list'] = "Tous les e-mails se trouvent déjà dans la liste noire.";
	$lang['spam_all_domains_on_domain_list'] = "Tous les domaines se trouvent déjà dans la liste noire.";
	...
	// SPAM_LOG.INC.PHP
	$lang['entries_uploaded'] = "{COUNTER} entrées ont été transmises en {TIME} secondes<br>à www.stopforumspam.com.";
	$lang['entries_sneaked'] = "{COUNTER} entrées ont été transmises en {TIME} secondes<br>à www.stopforumspam.com.";
	$lang['entries_already_sneaked'] = "Toutes les entrées ont déjà été transmises à <br>www.stopforumspam.com.";
	$lang['shortened'] = "&nbsp;[...]";
	$lang['last_contact'] = "Dernier contact il y a :";
	$lang['in_list_since'] = "Dans la liste depuis :";
	...
	$lang['report_spam'] = "Envoie l'entrée à www.stopforumspam.com et aide ainsi à réduire davantage le spam.";
	$lang['report_successfull'] = "Transfert réussi!";
	$lang['report_failed'] = "Transfert échoué!";
	$lang['sfs_username'] = "Nom d'utilisateur";
	$lang['sfs_email'] = "E-mail";
	$lang['sfs_ip'] = "Adresse IP";
	...
	$lang['gravatar_type_6'] = "Vide";

	// RECAPTCHA
 	$lang['captcha_method_recaptcha'] = "reCaptcha";
	$lang['captcha_method_ayah'] = "Êtes-vous un être humain ?";
	...
	$lang['confirm_report_to_stopforumspam'] = "Voulez-vous vraiment envoyer cette entrée à www.stopforumspam.com ?";
	$lang['confirm_report_spam'] = "Dénoncer !";
	...
	$lang['settings_fields'] = "Champs de formulaire";
	...
	$lang['settings_telemetry'] = "Statistiques d'utilisation";
	...
	$lang['sys_log'] = "Protokoll du système";
	...
	$lang['mastodon_nav'] = "MGB sur Mastodon";
	$lang['github_nav'] = "MGB sur GitHub";
	...
	$lang['edit_caption_fields'] = "Activer / désactiver les champs du formulaire";

 	$lang['edit_caption_bbcodes'] = "BBCodes";
 	$lang['edit_caption_smilies'] = "Émoticônes";
	...
	$lang['edit_caption_check_against_anti_spam_sites'] = "Vérification des visiteurs par rapport aux pages anti-spam";
	$lang['edit_caption_autoblock'] = "Blocage automatique d'adresses IP";
	$lang['edit_caption_http_referer'] = "Vérification HTTP Referer";
	$lang['edit_caption_captcha_settings'] = "Paramètres Captcha";
	$lang['edit_caption_mgb_captcha'] = 'Captcha propre à MGB';
 	$lang['edit_caption_recaptcha'] = "reCaptcha";
	$lang['edit_caption_ayah'] = "Ayah (Êtes-vous un être humain)";
	...
	$lang['edit_caption_telemetry'] = "Statistiques anonymes d'utilisation";
	...
	$lang['edit_caching'] = "Stockage temporaire (Caching):";
	...
	$lang['edit_captcha_noise_color'] = "Couleur des perturbations:";
	$lang['edit_captcha_noise_count'] = "Nombre:";
	...
	$lang['edit_database_client_version'] = "Client MySQL:";
	$lang['edit_database_server_version'] = "Serveur MySQL:";
	...
	$lang['edit_direct_access'] = "Interdire l'accès direct aux formulaires:";
	$lang['edit_direct_access_text'] = "URL du Referer:";
	$lang['edit_search_engines_excluded'] = "Exclure les moteurs de recherche:";
	$lang['edit_search_engines'] = "Identifiants des moteurs de recherche:";
	$lang['edit_check_against_anti_spam_sites'] = "Contrôle anti-spam:";
	$lang['edit_username_frequency'] = "Fréquence des noms d'utilisateur:";
	$lang['edit_email_frequency'] = "Fréquence des E-mails:";
	$lang['edit_ip_frequency'] = "Fréquence des adresses IP:";
	$lang['edit_for_ban_required'] = "Nécessaire pour le rejet:";
	$lang['edit_sfs_mark_as_spam'] = "Marquer comme spam:";
	$lang['edit_stopforumspam_api_key'] = "Clé API de www.stopforumspam.com";
	$lang['edit_ayah_pub_key'] = "Clé publique d'Ayah:";
	$lang['edit_ayah_score_key'] = "Clé de notation d'Ayah (Scoring Key):";
	$lang['edit_autoblock'] = "Blocage automatique d'adresses IP:";
	$lang['edit_autoblock_config'] = "Configuration:";
	$lang['edit_banlist_cleanup'] = "Nettoyage automatique de la liste noire:";
	$lang['edit_telemetry'] = "Statistiques anonymes d'utilisation:";
	$lang['edit_telemetry_ping'] = "Adresse pour le Ping:";
	$lang['edit_telemetry_install_id'] = "Identifiant unique de MGB:";
	...
	$lang['edit_expl_caching'] = "Si la mise en cache est activée, les entrées du livre de visiteurs ne sont pas récupérées à chaque fois dans la base de données, mais mises en cache sous forme de fichier html. Cela peut réduire la charge du serveur pour les pages très fréquentées. <br><br><b>ATTENTION : cette option est encore considérée comme expérimentale et devrait être désactivée par mesure de précaution en cas de problèmes d'affichage ou d'actualité des entrées.</b>";
	...
	$lang['edit_expl_captcha_add_noise'] = "Ajoute aléatoirement au Captcha des lignes de différentes longueurs, couleurs et orientations.";
	$lang['edit_expl_captcha_noise_color'] = "Détermine la couleur des lignes. Si aucune couleur n'est spécifiée, une couleur est choisie au hasard pour chaque ligne, créant ainsi des lignes « colorées ». La spécification est effectuée en notation hexadécimale sans « # ».<br><br><b>Correct: <span class=“newer_version”>505050</span><br>Incorrect: <span class=“old_version”>#505050</span></b>.";
	$lang['edit_expl_captcha_noise_count'] = "Indique le nombre de lignes.";
	...
	$lang['edit_expl_direct_access'] = "Si cette option est activée, l'accès direct à <i>newentry.php</i> et <i>email.php</i> est bloqué. Les spambots appellent généralement les formulaires directement afin de gagner du temps lors de la saisie. Une entrée n'est autorisée que si la variable <i>&#36;_SERVER[“HTTP_REFERER”]</i> <b>n'est pas vide</b> ou contient une URL spécifiquement définie (ou une partie de celle-ci). <br><br><b>INFO: le référent (Referer) est automatiquement transmis par le navigateur lors de l'appel d'une nouvelle page et contient généralement l'URL de la page qui mène à la nouvelle page (par exemple via un lien hypertexte).</b>";
	$lang['edit_expl_direct_access_text'] = "Ici, vous pouvez saisir une ou plusieurs URL spécifiques (séparées par des virgules) qui doivent figurer dans le référent (Referer) d'un formulaire d'inscription afin que l'accès soit autorisé. <br><br><b>– Laissez ce champ vide pour interdire l'accès uniquement lorsque le référent est vide, c'est-à-dire en cas d'appel direct. <br>– Veuillez saisir plusieurs domaines séparés par des virgules.</b>";
	$lang['edit_expl_search_engines_excluded'] = "Détermine si les moteurs de recherche sont exclus ou non de la réglementation.";
	$lang['edit_expl_search_engines'] = "Saisissez ici les identifiants des moteurs de recherche transmis dans le HTTP_REFERER, séparés par des virgules. Les différents référents sont ensuite vérifiés par rapport à ces identifiants. <br><br><b>Par défaut lors de l'installation: Googlebot/, Baiduspider, bingbot/, MJ12bot/, Exabot, ia_archiver, msnbot/, Yahoo! Slurp, SEO search Crawler/, crawleradmin.t-info@telekom.de</b>";
	$lang['edit_expl_check_against_anti_spam_sites'] = "Si cette option est activée, un visiteur sera vérifié sur newentry.php et email.php à l'aide des listes anti-spam de stopforumspam.com. Si cette vérification est positive, l'utilisateur est bloqué avant même de pouvoir créer une entrée. <br><br><b>Cette option doit être utilisée comme première barrière anti-spam.</b>";
	$lang['edit_expl_username_frequency'] = "Combien de fois le nom d'utilisateur doit-il être signalé comme « spam » sur www.stopforumspam.com avant d'être bloqué ?";
	$lang['edit_expl_email_frequency'] = "Combien de fois l'adresse E-mail doit-elle être signalé comme « spam » sur www.stopforumspam.com avant d'être bloqué ?";
	$lang['edit_expl_ip_frequency'] = "Combien de fois l'adresse IP doit-elle être signalé comme « spam » sur www.stopforumspam.com avant d'être bloqué ?";
	$lang['edit_expl_for_ban_required'] = "Cochez les cases nécessaires pour refuser l'inscription.";
	$lang['edit_expl_sfs_mark_as_spam'] = "Si cette option est mise sur <b>Oui</b>, les entrées rejetées sont acceptées, mais marquées comme spam et apparaissent dans l'administration sous <i>Entrées spam</i>. Sinon, l'utilisateur voit un message d'erreur et l'entrée n'est pas acceptée.";
	$lang['edit_expl_stopforumspam_api_key'] = "Pour signaler vous-même des entrées spam au site, vous devez saisir ici une clé API. Pour obtenir une clé API, vous devez vous inscrire sur le <a href=“http://www.stopforumspam.com/forum/” target=“_blank”>Forum</a> du site, puis <a href=“http://www.stopforumspam.com/signup” target=“_blank”>enregistrer une clé API</a>. <br><br><b>ATTENTION:</b> Aucune clé API n'est nécessaire pour vérifier les visiteurs par rapport à la liste. Vous n'en avez besoin que pour signaler vous-même des entrées.";
	$lang['edit_expl_ayah_pub_key'] = "Pour pouvoir utiliser « Are you a human? » (« Êtes-vous un être humain »), il faut saisir la clé publique. Vous pouvez en demander une avec la « Scoring Key » sur <a href=“http://www.areyouahuman.com/” target=“_blank”>areyouahuman.com</a>.";
	$lang['edit_expl_ayah_score_key'] = "Entrez ici la « Scoring Key » (« clé de notation ») de « Are you a human? » (« Êtes-vous un humain? »).";
	$lang['edit_expl_autoblock'] = "Faut-il ajouter automatiquement à la liste noire les adresses IP qui déclenchent un avertissement pendant la durée définie dans la configuration ?";
	$lang['edit_expl_autoblock_config'] = "Définit le délai dans lequel un avertissement doit être déclenché pour être automatiquement ajouté à la liste noire du livre des visiteurs.";
	$lang['edit_expl_banlist_cleanup'] = "Si cette option est activée, les entrées dans les listes noires sont automatiquement supprimées après la durée de blocage définie.";
	$lang['edit_expl_telemetry'] = "Si cette option est activée, le livre des visiteurs MGB envoie une fois par jour des informations techniques anonymes (version, version PHP, identifiant d'installation aléatoire).<br><br>Aucune donnée personnelle, telle que l'adresse IP, le lieu d'installation, etc., n'est transmise.";
	$lang['edit_expl_telemetry_ping'] = "Veuillez <b>ne pas</b> modifier cette adresse. Sauf si une contribution correspondante dans le forum officiel le demande <b>explicitement</b> !";
	$lang['edit_expl_telemetry_install_id'] = "Votre identifiant unique créé lors de l'installation du livre des visiteurs. Ne peut pas être modifié.";
	...
	$lang['sql_dump_successfull'] = "Sauvegarde SQL créée avec succès en {TIME} secondes.";
	$lang['time_needed'] = "Cela a pris {TIME} secondes.";
