<?php
	...
	*/
	...
	$lang['srvcfg_mysqliversion'] = "Extension MySQLi:";
	$lang['srvcfg_gd'] = "Bibliothek GD:";
	$lang['srvcfg_writable'] = "Configuration modifiable:";
 	$lang['srvcfg_reg_globals'] = "enregistrer_les_globaux:";

	// errormessages step 1
	$lang['error_1'] = "Votre version de PHP est dépassée. Une mise à jour est recommandée.<br><br><b>Mettez la valeur de la variable \'\'$ignore_warnings\'\' dans la ligne 58 du fichier install.php à «1», si vous voulez continuer malgré les avertissements.</b>";
	$lang['error_2'] = "Votre version de MySQL est dépassée. Une mise à jour est recommandée.<br><br><b>Mettez la valeur de la variable \'\'$ignore_warnings\'\' dans la ligne 58 du fichier install.php à «1», si vous voulez continuer malgré les avertissements.</b>";
	...
	$lang['error_6'] ="L'extension PHP mysqli n'est pas disponible ou est désactivée.";
	$lang['error_7'] = "Malheureusement, votre version MySQL ne peut pas être déterminée. Votre serveur MySQL fonctionne-t-il ?";
