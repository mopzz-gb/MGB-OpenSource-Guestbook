...
If you want to upgrade from any previous 0.6.x Version to this, open "install/upgrade.php"
...
IMPORTANT:
If you want to update from MGB 0.5.x then you must upgrade to the latest 0.6.x first. There is no way to update
directly to 0.7.x. Sorry, but 0.5.x is too old!
...
You can create your own templates and email it to me. You have to release it under GNU/GPL, otherwise
