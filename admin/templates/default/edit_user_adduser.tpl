...
<table summary="edit_user_single" class="edit_user_single" cellspacing="0" cellpadding="3">
	...
	<tr>
		...
		<td class="edit_user_r">
		<select class="option" name="r_telemetry" size="1"><option{SELECTED_R_TELEMETRY_0} value="0">{LANG_NO}</option><option{SELECTED_R_TELEMETRY_1} value="1">{LANG_YES}</option></select>
		</td>
	</tr>
	<tr>
		<td colspan="2" class="edit_user_overall">
